...
function salvar(){
  ...
  closeModal(); renderAll(); if(window.famSyncMeu) window.famSyncMeu();
...
function delTx(id){ if(!confirm('Remover?')) return; DB.removeTx(id); showToast('🗑 Removido'); renderAll(); if(window.famSyncMeu) window.famSyncMeu(); if(curPage==='entradas') renderEntradas(); if(curPage==='saidas') renderSaidas(); if(curPage==='historico') renderHist(); }
